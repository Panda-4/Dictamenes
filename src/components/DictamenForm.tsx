...
<option value="Otros">Otros</option>
              ...
              <div className="space-y-1 relative">
                ...
                <input 
                  ...
                  onChange={handleChange}
                  className="w-full bg-white/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-xl focus:ring-2 focus:ring-gem-primary/20 focus:border-gem-primary block p-3 transition-colors shadow-sm mt-1"
                />
              </div>
