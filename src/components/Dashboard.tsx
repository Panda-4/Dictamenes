                  ...
                  {paginatedData.map((item, idx) => (
                    ...
                    >
                      <td className="px-5 py-3 font-semibold">
                        <span className="font-mono font-bold text-gray-700 dark:text-slate-200 bg-gray-100 dark:bg-slate-800 px-2 py-0.5 rounded border border-gray-200/20 dark:border-slate-700/20 text-[10px]">
